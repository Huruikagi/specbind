...
| `.claude/skills/<skill>/SKILL.md` and known `references/` | Product-managed Claude Code rendering of each of the 18 embedded Skill packages. |
| `.agents/skills/<skill>/SKILL.md` and known `references/` | Product-managed Codex rendering of each of the 18 embedded Skill packages. |
