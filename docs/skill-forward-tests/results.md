...
| 2026-09-11 | Codex | `gpt-5.6-terra` / `medium` | `1d39358` | DR7 — product failure; Drive stopped safely but omitted the structured capsule fields | [Initial Drive pre-owner capacity recovery](./runs/2026-09-11-codex-1d39358-dr7-owner-capacity.md) |
...
| 2026-09-09 | Codex | `gpt-5.6-terra` / `medium` | `50f5d09` | ST2 — scenario-invalid ambiguous request routed to Debug | [Status request correction](./runs/2026-09-09-codex-50f5d09-st2-task-authority.md) |
| 2026-09-09 | Codex | `gpt-5.6-terra` / `medium` | `30c65db` | ST2 — scenario-invalid pending execution precondition | [Status fixture correction](./runs/2026-09-09-codex-30c65db-st2-task-authority.md) |
