...
| Integration validation | Cross-task behavior, full verification, spec coverage, and candidate evidence produced between the CLI completion preflight and guarded acceptance calls | Replacing missing task-level review or directly mutating completion state |
