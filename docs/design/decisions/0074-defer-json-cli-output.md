...
- Commands may still accept JSON as mutation input when a separate decision defines it. In particular, `specbind release finalize --log-entries <path|->` continues to consume the strict Decision 0068 JSON document.
