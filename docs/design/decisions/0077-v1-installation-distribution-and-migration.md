...
- Decisions 0093, 0152, and 0169 fix the seven accepted shared-Rule paths.
  ...
  only for Japanese projects. Decision 0101 fixes the release and Git adapter
  paths; install and refresh treat both sets as project-owned settings rather
  than product-managed skill assets.
