...
- The milestone and every participating spec remain active. SpecBind does not append release log entries, archive the roadmap or cross-spec review, remove active Brief or task artifacts, or clear an `active_change`.
