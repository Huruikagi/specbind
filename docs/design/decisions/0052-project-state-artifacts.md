...
- Successful release finalization moves the accepted active record to `{{SPEC_DIR}}/releases/<version>-cross-spec-review.md` alongside `<version>-roadmap.md`, refusing conflicting archive content. Confirmed milestone abandonment removes the active record without creating release history.
...
- The roadmap remains the canonical scope owner; `state/cross-spec-review.md` becomes the canonical owner of the current accepted global review evidence.
