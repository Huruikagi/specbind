...
The Rust core operations and later-boundary guards exist. Public Clap routing, candidate stream loading, concise rendering, stable exit behavior, and CLI integration tests for these two commands remain to be implemented.
