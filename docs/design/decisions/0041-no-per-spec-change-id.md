...
- Per-spec changelog and release-finalization idempotency use the release binding, milestone ID, enclosing spec identity, and immutable release reference as applicable; they do not require a change ID.
