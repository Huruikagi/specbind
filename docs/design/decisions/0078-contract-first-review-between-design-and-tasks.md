...
- Decision 0087 exposes this handshake as `specbind milestone review accept --candidate <path|->` and exposes the focused freshness summary as `specbind milestone review status`.
