...
- `brief.md`, `requirements.md`, `design.md`, `contract.md`, `implementation-notes.md`, `changelog.md`, steering documents, rules, templates, and the release adapter receive artifact-appropriate OKF frontmatter in the target model.
