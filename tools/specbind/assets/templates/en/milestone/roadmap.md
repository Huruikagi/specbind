...
Capture the request and reasoning shared by the whole milestone. Do not repeat
the machine-owned work-item index or use this body as lifecycle status. Remove,
rename, or add sections when that makes the current milestone clearer.
-->

<!-- specbind:instruction maintain
Keep this as the current milestone-wide request and rationale. When scope or
ordering changes, revise the explanation in place; Git and the released Roadmap
archive own history.
-->

<!-- specbind:instruction consume
Front Matter is authoritative for work items and dependencies. This body
explains the request, boundaries, decomposition, and reasoning behind them.
-->
