# Ordinary change Discovery

Read this procedure completely for an ordinary change request, including one
that carries an explicit local-files or GitHub Milestone Source Collection. Do
not use it to establish Specs from existing code or resume reverse
establishment.
