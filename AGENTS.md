...
- [`docs/design/decisions/0042-sequential-milestone-id.md`](docs/design/decisions/0042-sequential-milestone-id.md) — accepted `m-<natural number>` milestone IDs allocated through `.specbind.json`
